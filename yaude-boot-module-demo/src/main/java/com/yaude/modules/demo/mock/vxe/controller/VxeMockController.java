package com.yaude.modules.demo.mock.vxe.controller;
...
import com.yaude.modules.demo.mock.vxe.entity.MockEntity;
...
public class VxeMockController {
    ...
    private void mockChange(JSONObject rowData) {
        ...
        // 封裝消息字符串，這里的
        // type 必須是 VXESocketConst.TYPE_UVT
    ...
    public Result getMockData(
        ...
        // 模擬JSON數據路徑
        String path = "classpath:com/yaude/modules/demo/mock/vxe/json/dlglong.json";
        // 讀取JSON數據
    ...
    public Result getMockDdjhData(
        ...
        // 模擬JSON數據路徑
        String path = "classpath:com/yaude/modules/demo/mock/vxe/json/ddjh.json";
        if ("8".equals(status)) {
            path = "classpath:com/yaude/modules/demo/mock/vxe/json/ddjh_s8.json";
        }
        // 讀取JSON數據
        JSONArray dataList = readJsonData(path);
        if (dataList == null) {
