...
<div class="container-flex" tabindex="0" hidefocus="true">
    <div class="box-left">
        ...
        <div class="left-bottom" class="select">
            <div class="title-box">
                ...
                <button id="filBtn"><img src="${base}/bigscreen/template2/images/select_icon.png" alt="">篩選</button>
            </div>
            <div class="chart-box">
                <div class="filter-con" id="filCon" data-type="1">
                    ...
                    <div class="select" tabindex="0" hidefocus="true">
                        ...
                        <ul class="select-ul company">
                            ...
                            <li data-value="1">順豐</li>
                            <li data-value="2">京東</li>
                    ...
                    <div class="select" tabindex="0" hidefocus="true">
                        ...
                        <ul class="select-ul">
                            <li class="active" data-value="">快件類型</li>
    ...
    <div class="box-center">
        ...
        <div class="center-bottom">
            ...
            <div class="city-data">
                <div class="city-box">
                    <p id="titleQ"><span>全網</span>到珠海</p>
                    <ul class="city-btn" data-city="1">
                        <li class="active">全網</li>
                        <li>ABCDE</li>
                        <li>FGHIJ</li>
                        <li>KLMNO</li>
                        <li>PQRST</li>
                ...
                <ul class="ranking-box">
                    ...
                    <!--                        <li><span>1</span><p>上海</p><p>1sss25(萬件)</p></li>-->
                </ul>
    ...
    <div class="box-right">
        <div class="right-top">
            <div class="title-box">
                <h6 id="barTitle">派件數據</h6>
                <img class="line-img" src="${base}/bigscreen/template2/images/line-blue.png" alt="">
                <button data-state=1 id="tabBtn"><img src="${base}/bigscreen/template2/images/chart_icon.png" alt=""><span>圖表</span></button>
            </div>
            <p class="unit">單位：件</p>
            <div class="chart-box">
        ...
        <div class="right-center">
            <div class="title-box">
                <p id="switchBtn"><span class="active" data-dataType="income">收入數據</span><img class="line-img" src="${base}/bigscreen/template2/images/line-blue.png" alt=""><span data-dataType="expend">支出數據</span></p>
                <img class="line-img" src="${base}/bigscreen/template2/images/line-blue.png" alt="">
        ...
        <div class="right-bottom">
            <div class="title-box">
                <button id="setBtn"><img src="${base}/bigscreen/template2/images/settings_icon.png" alt="">設置</button>
            </div>
            <div class="data-box">
                <div class="settings-box">
                    <p><img src="${base}/bigscreen/template2/images/teacher_icon.png" alt="">今日值班：<span id="name_a"></span><span id="date_a"></span></p>
                    <p><img src="${base}/bigscreen/template2/images/people_iocn.png" alt="">負責人：<span id="lea_a"></span></p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    ...
    <div class="pop-up">
        ...
        <div class="cont-div">
            <h2 class="title" id="barTitles">派件數據</h2>
            <button class="btn-class" data-state=1 id="tabBtns"><img src="${base}/bigscreen/template2/images/chart_icon.png" alt=""><span>圖表</span></button>
            <div class="chart-box pop-chart">
        ...
        <div class="pop-data">
            <div class="city-data">
                <div class="city-box">
                    <p id="titleQs"><span>全網</span>到珠海</p>
