...
var config = {
    ...
    api: {
        ...
        group: 'js/plugins/layer/layim/data/group.json', //群組列表接口
        chatlog: 'js/plugins/layer/layim/data/chatlog.json', //聊天記錄接口
        groups: 'js/plugins/layer/layim/data/groups.json', //群組成員接口
        sendurl: '' //發送消息接口
    },
    user: { //當前用戶信息
        name: '游客',
...
xxim.popchatbox = function(othis){
    var node = xxim.node, dataId = othis.attr('data-id'), param = {
        ...
        name: othis.find('.xxim_onename').text(),  //用戶名
        face: othis.find('.xxim_oneface').attr('src'),  //用戶頭像
        href: 'profile.html?user=' + dataId //用戶主頁
...
xxim.view = (function(){
    var xximNode = xxim.layimNode = $('<div id="xximmm" class="xxim_main">'
            ...
            +'<li class="xxim_online" id="xxim_online">'
                +'<i class="xxim_nowstate fa fa-check-circle"></i><span id="xxim_onlinetex">在線</span>'
                +'<div class="xxim_setonline">'
                    +'<span><i class="fa fa-check-circle"></i>在線</span>'
            ...
            +'<li class="xxim_seter" id="xxim_seter" title="設置">'
