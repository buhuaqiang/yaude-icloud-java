package com.yaude.modules.ngalain.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.yaude.common.util.oConvertUtils;
import com.yaude.modules.ngalain.service.NgAlainService;
...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    /**
     * 通過URL生成路由name（去掉URL前綴斜杠，替換內容中的斜杠‘/’為-）
     * 舉例： URL = /isystem/role
