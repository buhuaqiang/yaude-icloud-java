...
public class FindsDepartsChildrenUtil {
    ...
    /**
     * queryTreeList的子方法====3====
     *該方法是找到頂級父類下的所有子節點集合并封裝到TreeList集合
     */
