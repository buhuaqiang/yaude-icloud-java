package com.yaude.modules.oss.service.impl;
...
import com.yaude.modules.oss.mapper.OSSFileMapper;
...
public class OSSFileServiceImpl extends ServiceImpl<OSSFileMapper, OSSFile> implements IOSSFileService {
	...
	public void upload(MultipartFile multipartFile) throws IOException {
		...
		//update-begin--Author:scott  Date:20201227 for：JT-361【文件預覽】阿里云原生域名可以文件預覽，自己映射域名kkfileview提示文件下載失敗-------------------
		// 返回阿里云原生域名前綴URL
		ossFile.setUrl(OssBootUtil.getOriginalUrl(url));
		//update-end--Author:scott  Date:20201227 for：JT-361【文件預覽】阿里云原生域名可以文件預覽，自己映射域名kkfileview提示文件下載失敗-------------------
		this.save(ossFile);
	}
